...
import { Container, Grid, InputAdornment, TextField, Typography, useMediaQuery, FormControl, RadioGroup, FormControlLabel, Radio } from "@mui/material";
    ...
    return (
        <div>
            <FormControl component="fieldset">
                <RadioGroup row aria-label="searchType" name="searchType" value={searchType} onChange={(e) => setSearchType(e.target.value)}>
                                        ...
                                        <Grid item xs={12}>
                                            <Typography variant="h5" align="left" sx={{
                                                ...
                                                {post.userImage ? (
                                                    ...
                                                    <AccountCircleIcon sx={{ marginRight: '1rem', fontSize: '3.5rem', width: '5rem', height: '5rem' }} />
                                                )}
                                                {post.username}
                                            </Typography>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={12}>
                                            <Typography variant="h5" align="left" sx={{
                                                ...
                                                {user.image ? (
                                                    <img src={user.image} alt="Profile" style={{ marginRight: '1rem', width: '5rem', height: '5rem', borderRadius: '50%' }} />
                                                ) : (
                                                    <AccountCircleIcon sx={{ marginRight: '1rem', fontSize: '3.5rem', width: '5rem', height: '5rem', }} />
                                                )}
                                                {user.username}
