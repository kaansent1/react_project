...
import de.kaan.dao.post_comments.PostCommentRow
...
class PostCommentsRepositoryImpl(
    ...
    override suspend fun getPostComments(postId: Long): Response<GetCommentsResponse> {
        val commentRows = commentsDao.getComments(postId = postId)
